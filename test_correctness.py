...
def run_demo(cfg, ckpt, score_threshold, images_dir, output_dir, dataset_type):
    ...
    for i, image_path in enumerate(image_paths):
        ...
        correct_result = np.load("{}.npy".format(image_path), allow_pickle=True).item()
        assert((result['boxes'] == correct_result['boxes']).all())
        assert((result['labels'] == correct_result['labels']).all())
        assert((result['scores'] == correct_result['scores']).all())
